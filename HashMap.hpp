...
#ifndef CISC220LAB5_HASHMAP_HPP
#define CISC220LAB5_HASHMAP_HPP
#endif //CISC220LAB5_HASHMAP_HPP
...
/**********************************************************************************/
std::string first; // for first keyword for printing to a file
int numKeys;
int mapSize;
...
int getIndex(std::string k); // uses calcHash and reHash to calculate and return the index of where the keyword
// k should be inserted into the map array
int calcHash(std::string k); // hash function
int calcHash2(std::string k); // hash function 2
...
int collHash1(int h, int i, std::string k); // getting index with collision method 1 (note – you may modify the
// parameters if you don’t need some/need more)
int collHash2(int h, int i, std::string k); // getting index with collision method 2 (note – you may modify the
// parameters if you don’t need some/need more)
int findKey(std::string k); //finds the key in the array and returns its index. If it's not in the array,
// returns -1
